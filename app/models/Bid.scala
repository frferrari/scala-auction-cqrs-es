...
object BidRejectionReason extends Enumeration {
  ...
  val SELF_BIDDING, SELLER_LOCKED, BIDDER_LOCKED, AUCTION_HAS_ENDED, AUCTION_NOT_YET_STARTED, WRONG_REQUESTED_QTY, NOT_ENOUGH_STOCK, BID_BELOW_ALLOWED_MIN = Value
}
